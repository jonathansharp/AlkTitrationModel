...
% Skip any input parameter equal to NaN or -999
if  isnan(SAL(x))    || SAL(x)==-999 ||...
    isnan(TMP(x))    || TMP(x)==-999 ||...
    isnan(DIC(x))    || DIC(x)==-999 ||...
    isnan(PH(x))     || PH(x) ==-999 ||...
    isnan(TP(x))     || TP(x)==-999 ||...
    isnan(TSI(x))    || TSI(x)==-999 ||...
    isnan(NH4(x))    || NH4(x)==-999 ||...
    isnan(H2S(x))    || H2S(x) ==-999 ||...
    isnan(MSW(x))    || MSW(x)==-999 ||...
    isnan(CA(x))     || CA(x) ==-999 ||...
    isnan(TORG1(x))  || TORG1(x)==-999 ||...
    isnan(PKORG1(x)) || PKORG1(x)==-999 ||...
    isnan(TORG2(x))  || TORG2(x)==-999 ||...
    isnan(PKORG2(x)) || PKORG2(x) ==-999 ||...
    isnan(TORG3(x))  || TORG3(x)==-999 ||...
    isnan(PKORG3(x)) || PKORG3(x)==-999
Result(x,:) = [NaN,NaN,NaN,NaN,NaN,NaN,NaN];
else
